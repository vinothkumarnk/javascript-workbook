...
const stringsToNumbs = (numbers) => numbers.map(x => Number(x))
const num =stringsToNumbs(strNums);


// With the same numbers, find the sum of the even values
const sumEvens = num.reduce(
(acc,val) => {
...
weatherStates = weather.map(x => x.weather_state_name);
